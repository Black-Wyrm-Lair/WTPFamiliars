...
IF ~IsGabber(%famsummoner%)~ THEN BEGIN famtalk
  ...
  IF ~CombatCounterLT(1)!TriggerOverride(%famsummoner%,Detect([ENEMY]))!InventoryFull(%famsummoner%)Global("WTPFAMLE","GLOBAL",2)!GlobalTimerNotExpired("#GSTAOUT","GLOBAL")~ THEN REPLY @42 GOTO fam1intopack
  IF ~CombatCounterLT(1)!TriggerOverride(%famsummoner%,Detect([ENEMY]))!InventoryFull(%famsummoner%)Global("WTPFAMNE","GLOBAL",2)!GlobalTimerNotExpired("#GSTAOUT","GLOBAL")~ THEN REPLY @42 GOTO fam2intopack
  IF ~CombatCounterLT(1)!TriggerOverride(%famsummoner%,Detect([ENEMY]))!InventoryFull(%famsummoner%)Global("WTPFAMCE","GLOBAL",2)!GlobalTimerNotExpired("#GSTAOUT","GLOBAL")~ THEN REPLY @42 GOTO fam3intopack
  ...
  IF ~OR(2)!CombatCounterLT(1)TriggerOverride(%famsummoner%,Detect([ENEMY]))!InventoryFull(%famsummoner%)Global("WTPFAMLE","GLOBAL",2)OR(2)HPPercentLT(Myself,50)HPPercentLT(%famsummoner%,30)%IsInBG1%~ THEN REPLY @15 GOTO fam1hurt_intopack
  IF ~OR(2)!CombatCounterLT(1)TriggerOverride(%famsummoner%,Detect([ENEMY]))!InventoryFull(%famsummoner%)Global("WTPFAMLE","GLOBAL",2)OR(2)HPPercentLT(Myself,50)HPPercentLT(%famsummoner%,45)%IsInSoA%~ THEN REPLY @15 GOTO fam1hurt_intopack
  IF ~OR(2)!CombatCounterLT(1)TriggerOverride(%famsummoner%,Detect([ENEMY]))!InventoryFull(%famsummoner%)Global("WTPFAMLE","GLOBAL",2)OR(2)HPPercentLT(Myself,50)HPPercentLT(%famsummoner%,60)%IsInToB%~ THEN REPLY @15 GOTO fam1hurt_intopack
  IF ~OR(2)!CombatCounterLT(1)TriggerOverride(%famsummoner%,Detect([ENEMY]))!InventoryFull(%famsummoner%)Global("WTPFAMLE","GLOBAL",2)OR(2)HPPercentLT(Myself,50)HPPercentLT(%famsummoner%,45)%IsInIWD%~ THEN REPLY @15 GOTO fam1hurt_intopack
  IF ~OR(2)!CombatCounterLT(1)TriggerOverride(%famsummoner%,Detect([ENEMY]))!InventoryFull(%famsummoner%)Global("WTPFAMNE","GLOBAL",2)OR(2)HPPercentLT(Myself,50)HPPercentLT(%famsummoner%,30)%IsInBG1%~ THEN REPLY @15 GOTO fam2hurt_intopack
  IF ~OR(2)!CombatCounterLT(1)TriggerOverride(%famsummoner%,Detect([ENEMY]))!InventoryFull(%famsummoner%)Global("WTPFAMNE","GLOBAL",2)OR(2)HPPercentLT(Myself,50)HPPercentLT(%famsummoner%,45)%IsInSoA%~ THEN REPLY @15 GOTO fam2hurt_intopack
  IF ~OR(2)!CombatCounterLT(1)TriggerOverride(%famsummoner%,Detect([ENEMY]))!InventoryFull(%famsummoner%)Global("WTPFAMNE","GLOBAL",2)OR(2)HPPercentLT(Myself,50)HPPercentLT(%famsummoner%,60)%IsInToB%~ THEN REPLY @15 GOTO fam2hurt_intopack
  IF ~OR(2)!CombatCounterLT(1)TriggerOverride(%famsummoner%,Detect([ENEMY]))!InventoryFull(%famsummoner%)Global("WTPFAMNE","GLOBAL",2)OR(2)HPPercentLT(Myself,50)HPPercentLT(%famsummoner%,45)%IsInIWD%~ THEN REPLY @15 GOTO fam2hurt_intopack
  IF ~OR(2)!CombatCounterLT(1)TriggerOverride(%famsummoner%,Detect([ENEMY]))!InventoryFull(%famsummoner%)Global("WTPFAMCE","GLOBAL",2)OR(2)HPPercentLT(Myself,50)HPPercentLT(%famsummoner%,30)%IsInBG1%~ THEN REPLY @15 GOTO fam3hurt_intopack
  IF ~OR(2)!CombatCounterLT(1)TriggerOverride(%famsummoner%,Detect([ENEMY]))!InventoryFull(%famsummoner%)Global("WTPFAMCE","GLOBAL",2)OR(2)HPPercentLT(Myself,50)HPPercentLT(%famsummoner%,45)%IsInSoA%~ THEN REPLY @15 GOTO fam3hurt_intopack
  IF ~OR(2)!CombatCounterLT(1)TriggerOverride(%famsummoner%,Detect([ENEMY]))!InventoryFull(%famsummoner%)Global("WTPFAMCE","GLOBAL",2)OR(2)HPPercentLT(Myself,50)HPPercentLT(%famsummoner%,60)%IsInToB%~ THEN REPLY @15 GOTO fam3hurt_intopack
  IF ~OR(2)!CombatCounterLT(1)TriggerOverride(%famsummoner%,Detect([ENEMY]))!InventoryFull(%famsummoner%)Global("WTPFAMCE","GLOBAL",2)OR(2)HPPercentLT(Myself,50)HPPercentLT(%famsummoner%,45)%IsInIWD%~ THEN REPLY @15 GOTO fam3hurt_intopack
  ...
  // Slap familiar
  IF ~CombatCounterLT(1)!TriggerOverride(%famsummoner%,Detect([ENEMY]))Range(LastTalkedToBy,3)~ THEN REPLY @100 GOTO famslap1
  // Feed familiar
  ...
  // Say goodbye
  IF ~CombatCounterLT(1)!TriggerOverride(%famsummoner%,Detect([ENEMY]))ReputationGT(%famsummoner%,15)~ THEN REPLY @27 GOTO famcomplain
  IF ~CombatCounterLT(1)!TriggerOverride(%famsummoner%,Detect([ENEMY]))ReputationLT(%famsummoner%,6)~ THEN REPLY @27 GOTO fam1happy
  IF ~CombatCounterLT(1)!TriggerOverride(%famsummoner%,Detect([ENEMY]))ReputationLT(%famsummoner%,16)ReputationGT(%famsummoner%,5)~ THEN REPLY @27 GOTO famneutral
  // Ask help for fight
...
IF ~~ THEN BEGIN fampet
  ...
  // Ask hurt familiar to seek safety into backpack, familiar rejects
  IF ~!InventoryFull(%famsummoner%)GlobalTimerNotExpired("#GSTAOUT","GLOBAL")~ THEN REPLY @101 GOTO famnotpack
  // Slap familiar
  IF ~Range(LastTalkedToBy,3)~ THEN REPLY @100 GOTO famslap1
  // Ask for advice
  ...
  // Say goodbye
  IF ~ReputationGT(%famsummoner%,17)~ THEN REPLY @48 GOTO famcomplain
  IF ~ReputationLT(%famsummoner%,6)~ THEN REPLY @48 GOTO fam1happy
  IF ~ReputationLT(%famsummoner%,17)ReputationGT(%famsummoner%,6)~ THEN REPLY @48 GOTO famneutral
END
...
IF ~~ THEN BEGIN fam1intopack
  SAY @30
  IF ~~ THEN DO ~GivePartyAllEquipment()ReallyForceSpellRES("wtpclear",Myself)Wait(1)GiveItemCreate("wtpfmimp",%famsummoner%,0,0,0)SetGlobalTimer("#GWANOUT","GLOBAL",ONE_HOUR)SetGlobalTimer("#GSTAOUT","GLOBAL",FOUR_HOURS)DestroySelf()~ EXIT
END

IF ~~ THEN BEGIN fam2intopack
  SAY @30
  IF ~~ THEN DO ~SetGlobal("#GEMPCHA","GLOBAL",1)GivePartyAllEquipment()ReallyForceSpellRES("wtpclear",Myself)Wait(1)GiveItemCreate("wtpfmmep",%famsummoner%,0,0,0)SetGlobalTimer("#GWANOUT","GLOBAL",ONE_HOUR)SetGlobalTimer("#GSTAOUT","GLOBAL",FOUR_HOURS)DestroySelf()~ EXIT
END

IF ~~ THEN BEGIN fam3intopack
  SAY @30
  IF ~~ THEN DO ~SetGlobal("#GEMPCHA","GLOBAL",1)GivePartyAllEquipment()ReallyForceSpellRES("wtpclear",Myself)Wait(1)GiveItemCreate("wtpfmqua",%famsummoner%,0,0,0)SetGlobalTimer("#GWANOUT","GLOBAL",ONE_HOUR)SetGlobalTimer("#GSTAOUT","GLOBAL",FOUR_HOURS)DestroySelf()~ EXIT
END
...
IF ~~ THEN BEGIN fam1hurt_intopack
  SAY @16
  IF ~~ THEN DO ~SetGlobal("#GEMPCHA","GLOBAL",1)GivePartyAllEquipment()ReallyForceSpellRES("wtpclear",Myself)Wait(1)GiveItemCreate("wtpfmimp",%famsummoner%,0,0,0)SetGlobalTimer("#GWANOUT","GLOBAL",ONE_HOUR)SetGlobalTimer("#GSTAOUT","GLOBAL",FOUR_HOURS)DestroySelf()~ EXIT
END
...
IF ~~ THEN BEGIN famslap1
  ...
  IF ~!InventoryFull(%famsummoner%)GlobalTimerNotExpired("#GSTAOUT","GLOBAL")~ THEN REPLY @101 GOTO famnotpack
  // Pet familiar
  IF ~~ THEN REPLY @105 GOTO famslap_pet
  // Slap familiar
  IF ~RandomNum(3,1)~ THEN REPLY @107 GOTO famslap2
  IF ~RandomNum(3,2)~ THEN REPLY @107 GOTO famslap3
  IF ~RandomNum(3,3)~ THEN REPLY @107 GOTO famslap4
  // Ask for advice
  IF ~%IsInBG1%~ THEN REPLY @45 GOTO bg1_advice
  IF ~%IsInSoA%~ THEN REPLY @45 GOTO soa_advice
  IF ~%IsInToB%~ THEN REPLY @45 GOTO tob_advice
  IF ~%IsInIWD%~ THEN REPLY @45 GOTO iwd_advice
  // Ask familiar how it is
  IF ~~ THEN REPLY @106 GOTO famstatus
  // Ask familiar to stay close
  IF ~Global("#GAFTER","GLOBAL",0)~ THEN REPLY @5 GOTO famclose
  // Tell familiar that he can roam freely
  IF ~Global("#GAFTER","GLOBAL",1)~ THEN REPLY @6 GOTO famroam
  // Say goodbye
  IF ~~ THEN REPLY @48 GOTO famneutral
END
